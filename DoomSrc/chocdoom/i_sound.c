...
// (Default: 64MB)
// changed to one, cause we don't have the memory space

int snd_cachesize = 1 * 1024 * 1024;

// Config variable that controls the sound buffer size.
// We default to 28ms (1000 / 35fps = 1 buffer per tic).last_touch_state.status)
