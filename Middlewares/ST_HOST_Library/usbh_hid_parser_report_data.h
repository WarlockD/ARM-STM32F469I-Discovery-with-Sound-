#ifndef __USBH_HID_PARSER_REPORT_DATA_H
#define __USBH_HID_PARSER_REPORT_DATA_H

// Copyied from LUFA but its just soooo good and a great idea to make reports
// such macro genius here
